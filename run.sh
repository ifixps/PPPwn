...
/root/PPPwn-main/${script_name} --interface $interface --fw $firmware --stage1 /root/PPPwn-main/stage1_$firmware.bin --stage2 /root/PPPwn-main/stage2_$firmware.bin --auto-retry 
